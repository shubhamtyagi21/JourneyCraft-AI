...
/**
 * HotelCard component displays information about a single hotel, including a photo,
 * name, and address. It uses the Google Places API to fetch a photo of the hotel and
 * creates a link to its location on Google Maps. Includes robust error handling for
 * photo retrieval and gracefully handles missing data.
 *
 * @param {object} place - An object containing hotel details (name, address).
 * @param {object} dest - An object containing destination details (address). Used to refine
 *                        the photo search.  This parameter is likely redundant and could be removed
 *                        if the hotel's address is sufficient for the API call.
 * @returns {JSX.Element} The HotelCard component.
 */


function HotelCard({ place, dest }) {
